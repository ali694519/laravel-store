              ...
              @foreach ($products as $product)
                <div class="single-slider" style="background-image: url({{ $product->image_url }});">
                  <div class="content">
                    ...
                    <div class="button">
                      <a href="{{ route('products.show', $product->id) }}" class="btn">Shop Now</a>
                    </div>
                  </div>
                </div>
              @endforeach
        ...
        <div class="col-lg-4 col-12">
          <div class="row">
            <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
              <!-- Start Small Banner -->
              <div class="hero-small-banner" style="background-image: url('{{ $latestProduct->image_url }}');">
                <div class="content">
                  <h2>
                    <span>New line required</span>
                    iPhone 12 Pro Max
                  </h2>
                  <h3>{{ $latestProduct->price }}$</h3>
                </div>
              </div>
              <!-- End Small Banner -->
            </div>
      ...
      <div class="row">
        @foreach ($categories as $category)
          <div class="col-lg-4 col-md-6 col-12">
            ...
            <x-category-cared :category="$category" />
            <!-- End Single Product -->
          </div>
        @endforeach
      </div>
